...
FROM
	s20a_wide.forced as f1
	LEFT JOIN s20a_wide.forced2 as f2 USING (object_id)
	LEFT JOIN s20a_wide.forced4 as f4 USING (object_id)
	LEFT JOIN s20a_wide.forced5 as f5 USING (object_id)
	LEFT JOIN s20a_wide.meas as m USING (object_id)
	LEFT JOIN s20a_wide.mag_corr as c USING (object_id)
	LEFT JOIN s20a_wide.photoz_mizuki as p1 USING (object_id)
	LEFT JOIN s20a_wide.photoz_dnnz as p2 USING (object_id)
	LEFT JOIN s20a_wide.photoz_demp as p3 USING (object_id)
