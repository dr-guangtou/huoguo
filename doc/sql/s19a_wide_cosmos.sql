SELECT
	...
	b.g_mask_s18a_bright_objectcenter as g_pixelflags_bright_object,
	b.r_mask_s18a_bright_objectcenter as r_pixelflags_bright_object,
	b.i_mask_s18a_bright_objectcenter as i_pixelflags_bright_object,
	b.z_mask_s18a_bright_objectcenter as z_pixelflags_bright_object,
	b.y_mask_s18a_bright_objectcenter as y_pixelflags_bright_object,
...
FROM
	s19a_wide.forced as f1
	LEFT JOIN s19a_wide.forced2 as f2 USING (object_id)
	LEFT JOIN s19a_wide.forced4 as f4 USING (object_id)
	LEFT JOIN s19a_wide.forced5 as f5 USING (object_id)
	LEFT JOIN s19a_wide.meas as m USING (object_id)
	LEFT JOIN s19a_wide.masks as b USING (object_id)
	LEFT JOIN s19a_wide.photoz_v2_mizuki as p1 USING (object_id)
	LEFT JOIN s19a_wide.photoz_v2_dnnz as p2 USING (object_id)
	LEFT JOIN s19a_wide.photoz_v2_demp as p3 USING (object_id)
