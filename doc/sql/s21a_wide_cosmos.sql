SELECT
	...
	p2.photoz_mean as pz_mean_demp, 
	p2.photoz_best as pz_best_demp, 
	p2.photoz_conf_mean as pz_conf_mean_demp, 
	p2.photoz_conf_best as pz_conf_best_demp, 
	p2.photoz_risk_mean as pz_risk_mean_demp, 
	p2.photoz_risk_best as pz_risk_best_demp,
	p2.photoz_std_mean as pz_std_mean_demp, 
	p2.photoz_std_best as pz_std_best_demp,
	p2.photoz_err68_min as pz_err68_min_demp, 
	p2.photoz_err68_max as pz_err68_max_demp	

FROM
	s21a_wide.forced as f1
	LEFT JOIN s21a_wide.forced2 as f2 USING (object_id)
	LEFT JOIN s21a_wide.forced4 as f4 USING (object_id)
	LEFT JOIN s21a_wide.forced5 as f5 USING (object_id)
	LEFT JOIN s21a_wide.meas as m USING (object_id)
	LEFT JOIN s21a_wide.mag_corr as c USING (object_id)
	LEFT JOIN s21a_wide.photoz_mizuki as p1 USING (object_id)
	LEFT JOIN s21a_wide.photoz_demp as p2 USING (object_id)
